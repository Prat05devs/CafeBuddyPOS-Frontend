    ...
    <Card className={`bg-gradient-glass backdrop-blur-md border-glass-border overflow-hidden hover:shadow-medium transition-all duration-300 ${
      ...
      <div className="p-3 sm:p-4">
        <div className="flex items-start justify-between mb-2">
          ...
          <Badge variant={item.available ? 'default' : 'secondary'} className={`text-xs ${item.available ? 'bg-success hover:bg-success text-success-foreground' : ''}`}>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <Badge variant={item.available ? 'default' : 'secondary'} className={item.available ? 'bg-success hover:bg-success text-success-foreground' : ''}>
                {item.available ? 'Available' : 'Unavailable'}
              </Badge>
            </div>
